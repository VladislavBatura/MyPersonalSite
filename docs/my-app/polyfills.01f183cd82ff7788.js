    ...
    955: (fe, ge, me) => {
      const we = "undefined" != typeof globalThis && globalThis,
        ...
        Pe =
          ...
          self,
        Re = we || ("undefined" != typeof global && global) || Me || Pe,
        Te = function ($, ...O) {
          if (Te.translate) {
            const Y = Te.translate($, O);
            ($ = Y[0]), (O = Y[1]);
          }
          let se = oe($[0], $.raw[0]);
      ...
      function oe($, O) {
        return ":" === O.charAt(0)
          ? $.substring(
              (function ye($, O) {
                for (let se = 1, Y = 1; se < $.length; se++, Y++)
                  if ("\\" === O[Y]) Y++;
                  else if (":" === $[se]) return se;
                throw new Error(
                  `Unterminated $localize metadata block in "${O}".`
                );
              })($, O) + 1
            )
          : $;
      }
      (Re.$localize = Te), me(583);
    },
    583: () => {
      !(function (e) {
        ...
        let d = (() => {
          class M {
            ...
            static assertZonePatched() {
              if (e.Promise !== le.ZoneAwarePromise)
                throw new Error(
            ...
            runTask(t, r, k) {
              ...
              if (t.state === x && (t.type === te || t.type === w)) return;
              const C = t.state != y;
              C && t._transitionTo(y, j), t.runCount++;
              const J = ae;
              (ae = t), (U = { parent: U, zone: this });
              try {
                t.type == w &&
                  t.data &&
                  !t.data.isPeriodic &&
                ...
                t.state !== x &&
                  t.state !== h &&
                  (t.type == te || (t.data && t.data.isPeriodic)
            ...
            scheduleTask(t) {
              ...
              return (
                ...
                t.state == z && t._transitionTo(j, z),
                t
              );
            }
            scheduleMicroTask(t, r, k, C) {
              return this.scheduleTask(new p(L, t, r, k, C, void 0));
            }
            scheduleMacroTask(t, r, k, C, J) {
              return this.scheduleTask(new p(w, t, r, k, C, J));
            }
            scheduleEventTask(t, r, k, C, J) {
              return this.scheduleTask(new p(te, t, r, k, C, J));
            }
            cancelTask(t) {
              if (t.zone != this)
                throw new Error(
        ...
        let ee,
          ...
          H = !1;
        function q(M) {
          if ((ee || (e[N] && (ee = e[N].resolve(0))), ee)) {
            let E = ee[I];
            E || (E = ee.then), E.call(ee, M);
          } else e[A](M, 0);
        }
        function R(M) {
          0 === ne && 0 === F.length && q(_), M && F.push(M);
        }
        function _() {
          if (!H) {
            for (H = !0; F.length; ) {
      ...
      const fe = Object.getOwnPropertyDescriptor,
        ...
        Re = Zone.__symbol__(Pe),
        Te = Zone.__symbol__(Oe),
        re = "true",
        oe = "false",
        ye = Zone.__symbol__("");
      function De(e, n) {
      ...
      const O = Zone.__symbol__,
        se = "undefined" != typeof window,
        Y = se ? window : void 0,
        K = (se && Y) || ("object" == typeof self && self) || global;
      function Ae(e, n) {
        for (let i = e.length - 1; i >= 0; i--)
          "function" == typeof e[i] && (e[i] = De(e[i], n + "_" + i));
        return e;
      }
      function Be(e) {
        return (
      ...
      const Fe =
        ...
        We = function (e) {
          ...
          let n = Ne[e.type];
          n || (n = Ne[e.type] = O("ON_PROPERTY" + e.type));
          const i = this || e.target || K,
            o = i[n];
          let c;
          if (je && i === Y && "error" === e.type) {
            const a = e;
            (c =
              o &&
      ...
      function Ce(e) {
        ...
        for (o in n)
          "prototype" !== o && n.hasOwnProperty(o) && (K[e][o] = n[o]);
      }
      function he(e, n, i) {
        let o = e;
        for (; o && !o.hasOwnProperty(n); ) o = me(o);
        !o && e[n] && (o = e);
        const c = O(n);
        let a = null;
        if (
          ...
          (a) =>
            function (T, d) {
              ...
              return b.cbIdx >= 0 && "function" == typeof d[b.cbIdx]
                ? $(b.name, d[b.cbIdx], b, c)
                : a.apply(T, d);
            }
        );
      }
      function de(e, n) {
        e[O("OriginalDelegate")] = n;
      }
      let Xe = !1,
        He = !1;
      function ft() {
      ...
      Zone.__load_patch("ZoneAwarePromise", (e, n, i) => {
        ...
        const N = T("unhandledPromiseRejectionHandler");
        function I(l) {
          i.onUnhandledError(l);
          try {
            const u = n[N];
        ...
        function X(l, u, s) {
          ...
          if (l[q] === j) {
            ...
            if (
              ...
              ae(s), X(l, s[q], s[R]);
            else if (u !== G && "function" == typeof m)
              try {
                m.call(s, f(L(l, u)), f(L(l, !1)));
              } catch (P) {
                f(() => {
                  X(l, !1, P);
                })();
              ...
              for (let g = 0; g < P.length; )
                ne(l, P[g++], P[g++], P[g++], P[g++]);
              if (0 == P.length && u == G) {
                l[q] = 0;
                let g = s;
                try {
            ...
            () => {
              try {
                const S = l[R],
                  D = !!s && _ === s[_];
                D && ((s[Q] = S), (s[x] = P));
                const Z = u.run(g, void 0, D && g !== ee && g !== H ? [] : [S]);
                X(s, !0, Z);
              } catch (S) {
                X(s, !1, S);
              }
        ...
        class t {
          ...
          static any(u) {
            ...
            let f = 0;
            try {
              for (let g of u) f++, s.push(t.resolve(g));
            } catch (g) {
              return Promise.reject(new E([], "All promises were rejected"));
            }
            if (0 === f)
                ...
                s[D].then(
                  ...
                  (Z) => {
                    P.push(Z),
                      f--,
                      0 === f &&
                        ((m = !0), S(new E(P, "All promises were rejected")));
                  }
                );
            });
          }
          static race(u) {
            ...
            for (let S of u) F(S) || (S = this.resolve(S)), S.then(P, g);
            return m;
          }
          static all(u) {
          ...
          static allWithCallback(u, s) {
            ...
            const D = [];
            for (let Z of u) {
              F(Z) || (Z = this.resolve(Z));
              const V = S;
              try {
                Z.then(
                  (B) => {
                    (D[V] = s ? s.thenCallback(B) : B), g--, 0 === g && f(D);
                  },
                  (B) => {
                    s
                      ? ((D[V] = s.errorCallback(B)), g--, 0 === g && f(D))
                      : m(B);
                  }
                );
              } catch (B) {
          ...
          then(u, s) {
            ...
            const m = new f(M),
              P = n.current;
            return (
              this[q] == j ? this[R].push(P, m, u, s) : ne(this, P, m, u, s), m
            );
          }
          catch(u) {
            ...
            const m = n.current;
            return (
              this[q] == j ? this[R].push(m, f, u, u) : ne(this, m, f, u, u), f
            );
          }
        }
        (t.resolve = t.resolve),
      ...
      const ht = { useG: !0 },
        ie = {},
        Ye = {},
        $e = new RegExp("^" + ye + "(\\w+)(true|false)$"),
        Ke = O("propagationStopped");
      function Je(e, n) {
        const i = (n ? n(e) : e) + oe,
          o = (n ? n(e) : e) + re,
          c = ye + i,
          a = ye + o;
        (ie[e] = {}), (ie[e][oe] = c), (ie[e][re] = a);
      }
      function dt(e, n, i, o) {
        const c = (o && o.add) || Pe,
          a = (o && o.rm) || Oe,
        ...
        function ee(R, _) {
          if (!R) return !1;
          let Q = !0;
          _ && void 0 !== _.useG && (Q = _.useG);
          const x = _ && _.vh;
          let z = !0;
          _ && void 0 !== _.chkDup && (z = _.chkDup);
          let j = !1;
          _ && void 0 !== _.rt && (j = _.rt);
          let y = R;
          for (; y && !y.hasOwnProperty(c); ) y = me(y);
          ...
          _ && _.prepend && (X = y[O(_.prepend)] = y[_.prepend]);
          const t = Q
              ? function (s) {
                  if (!h.isExisting)
                    return L.call(
              ...
              : function (s) {
                  return L.call(h.target, h.eventName, s.invoke, h.options);
                },
            r = Q
              ? function (s) {
                  if (!s.isRemoved) {
                    const f = ie[s.eventName];
                    let m;
                    f && (m = f[s.capture ? re : oe]);
                    const P = m && s.target[m];
                    if (P)
                      for (let g = 0; g < P.length; g++)
                        if (P[g] === s) {
                          P.splice(g, 1),
                            (s.isRemoved = !0),
                            0 === P.length &&
                              ((s.allRemoved = !0), (s.target[m] = null));
                          break;
                        }
                  }
                  if (s.allRemoved)
            ...
            C =
              _ && _.diff
                ...
                : function (s, f) {
                    const m = typeof f;
                    return (
                      ("function" === m && s.callback === f) ||
                      ("object" === m && s.originalDelegate === f)
                    );
                  },
            J = Zone[O("UNPATCHED_EVENTS")],
            l = e[O("PASSIVE_EVENTS")],
            u = function (s, f, m, P, g = !1, S = !1) {
              return function () {
                const D = this || e;
                let Z = arguments[0];
                ...
                const Ge = !!ue && ("boolean" == typeof ue || ue.capture),
                  nt = !(!ue || "object" != typeof ue) && ue.once,
                  mt = Zone.current;
                let Ve = ie[Z];
                Ve || (Je(Z, G), (Ve = ie[Z]));
                const rt = Ve[Ge ? re : oe];
                let Le,
                  be = D[rt],
                  ot = !1;
                if (be) {
                ...
                it && (Le = it[Z]),
                  ...
                  (h.eventName = Z),
                  (h.isExisting = ot);
                const Se = Q ? ht : void 0;
                Se && (Se.taskData = h);
                const Ee = mt.scheduleEventTask(Le, V, Se, m, P);
                return (
                  (h.target = null),
                  Se && (Se.taskData = null),
                  nt && (ue.once = !0),
                  (!ke && "boolean" == typeof Ee.options) || (Ee.options = ue),
                  (Ee.target = D),
                  (Ee.capture = Ge),
                  (Ee.eventName = Z),
                  B && (Ee.originalDelegate = V),
                  S ? be.unshift(Ee) : be.push(Ee),
                  g ? D : void 0
                );
              };
            };
          return (
            ...
            (y[a] = function () {
              ...
              const m = arguments[2],
                P = !!m && ("boolean" == typeof m || m.capture),
                g = arguments[1];
              if (!g) return w.apply(this, arguments);
              if (x && !x(w, g, s, arguments)) return;
              const S = ie[f];
              let D;
              S && (D = S[P ? re : oe]);
              const Z = D && s[D];
            ...
            (y[T] = function () {
              ...
              for (let g = 0; g < P.length; g++) {
                const S = P[g];
                m.push(S.originalDelegate ? S.originalDelegate : S.callback);
              }
              return m;
            }),
            (y[d] = function () {
        ...
        let q = [];
        for (let R = 0; R < i.length; R++) q[R] = ee(i[R], o);
        return q;
      }
      function Qe(e, n) {
        if (!n) {
            ...
            b &&
              ...
              c.forEach(function (p) {
                ...
                if (N.hasOwnProperty(p)) {
                  const I = e.ObjectGetOwnPropertyDescriptor(N, p);
                  I && I.value
                    ? ((I.value = e.wrapWithCurrentZone(I.value, A)),
                      e._redefineProperty(b.prototype, p, I))
                    : N[p] && (N[p] = e.wrapWithCurrentZone(N[p], A));
                } else N[p] && (N[p] = e.wrapWithCurrentZone(N[p], A));
              }),
            T.call(n, d, b, v)
          );
        }),
      ...
      Zone.__load_patch("util", (e, n, i) => {
        ...
        e[a] && (e[c] = e[a]),
          ...
          (i.isIEOrEdge = ft),
          (i.ObjectDefineProperty = ge),
          (i.ObjectGetOwnPropertyDescriptor = fe),
          (i.ObjectCreate = we),
          (i.ArraySlice = Me),
          (i.patchClass = Ce),
          (i.wrapWithCurrentZone = De),
          (i.filterProperties = et),
          (i.attachOriginToPatched = de),
          ...
          (i.getGlobalObjects = () => ({
            ...
            TRUE_STR: re,
            FALSE_STR: oe,
            ZONE_SYMBOL_PREFIX: ye,
            ADD_EVENT_LISTENER_STR: Pe,
            ...
            function (p, A) {
              if ("function" == typeof A[0]) {
                const N = {
                    ...
                    delay:
                      "Timeout" === o || "Interval" === o ? A[1] || 0 : void 0,
                    args: A,
                  },
                  I = A[0];
                A[0] = function () {
                ...
                return (
                  "number" == typeof H ? (T[H] = F) : H && (H[Ie] = F),
                  H &&
                    H.ref &&
                    H.unref &&
                ...
                "number" == typeof N
                  ...
                  I && "string" == typeof I.type
                    ? "notScheduled" !== I.state &&
                      ...
                      ("number" == typeof N ? delete T[N] : N && (N[Ie] = null),
                      I.zone.cancelTask(I))
                    : v.apply(e, A);
              }
          ));
      ...
      Zone.__load_patch("legacy", (e) => {
        ...
        Zone.__load_patch("on_property", (e, n, i) => {
          !(function Tt(e, n) {
            if ((Ze && !Ue) || Zone[e.symbol("patchEvents")]) return;
        ...
        Zone.__load_patch("XHR", (e, n) => {
          !(function b(v) {
            ...
            function q(h) {
              ...
              (w[a] = !1), (w[d] = !1);
              const te = w[c];
              I || ((I = w[Re]), (F = w[Te])), te && F.call(w, H, te);
              const le = (w[c] = () => {
                if (w.readyState === w.DONE)
                  if (!L.aborted && w[a] && h.state === ee) {
                    const U = w[n.__symbol__("loadfalse")];
                    if (0 !== w.status && U && U.length > 0) {
                      const ae = h.invoke;
                      (h.invoke = function () {
                        const ne = w[n.__symbol__("loadfalse")];
                        for (let W = 0; W < ne.length; W++)
                          ne[W] === h && ne.splice(W, 1);
                        !L.aborted && h.state === ee && ae.call(h);
                      }),
                        U.push(h);
                    } else h.invoke();
                  } else !L.aborted && !1 === w[a] && (w[d] = !0);
              });
              return (
                I.call(w, H, le),
                w[i] || (w[i] = h),
            ...
            function _(h) {
              const L = h.data;
              return (L.aborted = !0), G.apply(L.target, L.args);
            }
            const Q = he(
                A,
                "open",
                () =>
                  function (h, L) {
                    return (h[o] = 0 == L[2]), (h[T] = L[1]), Q.apply(h, L);
                  }
              ),
              z = O("fetchTaskAborting"),
              j = O("fetchTaskScheduling"),
              y = he(
                A,
                "send",
                () =>
                  function (h, L) {
                    if (!0 === n.current[j] || h[o]) return y.apply(h, L);
                    {
                      const w = {
                          target: h,
                          url: h[T],
                        ...
                        te = $("XMLHttpRequest.send", R, w, q, _);
                      h &&
                        !0 === h[d] &&
                        !w.aborted &&
                        te.state === ee &&
                  ...
                  function (h, L) {
                    ...
                    if (w && "string" == typeof w.type) {
                      if (null == w.cancelFn || (w.data && w.data.aborted))
                        return;
                      w.zone.cancelTask(w);
                    } else if (!0 === n.current[z]) return G.apply(h, L);
                  }
              );
          })(e);
          const i = O("xhrTask"),
        ...
        Zone.__load_patch("PromiseRejectionEvent", (e, n) => {
          ...
          e.PromiseRejectionEvent &&
            ((n[O("unhandledPromiseRejectionHandler")] =
              i("unhandledrejection")),
            (n[O("rejectionHandledHandler")] = i("rejectionhandled")));
        });
    },
  },
  (fe) => {
